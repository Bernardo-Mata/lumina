...
def get_unified_llm_response(filename):
    ...
    "   - description (string)\n"
    "   - solutions (string)\n"
    "   - risk_type (string: Supply, Demand, Operational, Financial, Geopolitical, Environmental, Reputational)\n"
    "   - risk_reason (string) # Briefly explain why this alert is categorized under this risk_type. For example, if risk_type is 'Supply', risk_reason could be 'Stock levels are critically low and supplier delays detected.'\n"
    "     # Classify each alert according to the main supply chain risk types: \n"
    "     # - Supply: supplier failure, material shortage, quality issues\n"
    "     # - Demand: demand fluctuation, forecast errors\n"
    "     # - Operational: process failures, logistics, technology issues\n"
    "     # - Financial: price volatility, currency, liquidity\n"
    "     # - Geopolitical: political instability, regulatory changes\n"
    "     # - Environmental: natural disasters, pandemics\n"
    "     # - Reputational: compliance, ethics, public image\n"
    "Example:\n"
    "[{\"priority\": \"High\", \"sku\": \"DISH0\", \"product_type\": \"Main Course\", \"availability\": 7, \"stock_levels\": 3, \"lead_time\": 12, \"description\": \"Very low stock and high lead time. Risk of supply disruption.\", \"solutions\": \"Increase inventory levels; Negotiate faster deliveries with suppliers\", \"risk_type\": \"Supply\", \"risk_reason\": \"Stock levels are critically low and supplier delays detected.\"}]\n\n"
    ...
    "   - risk_type (string: Supply, Demand, Operational, Financial, Geopolitical, Environmental, Reputational)\n"
    "   - risk_reason (string) # Briefly explain why this risk is categorized under this risk_type.\n"
    "     # Classify each risk according to the main supply chain risk types as described above.\n"
    "Example:\n"
    "[{\"supplier\": \"Supplier A\", \"category\": \"Logistics\", \"risk_score\": 78, \"reason\": \"High risk due to financial instability\", \"level\": \"Medium\", \"risk_type\": \"Financial\", \"risk_reason\": \"Supplier has shown late payments and cash flow issues.\"}]\n\n"
    ...
    "   - risk_type (string: Supply, Demand, Operational, Financial, Geopolitical, Environmental, Reputational)\n"
    "   - risk_reason (string) # Briefly explain why this disruption is categorized under this risk_type.\n"
    "     # Classify the disruption according to the main supply chain risk types as described above.\n"
    "Example:\n"
    "[{\"detected\": true, \"summary\": \"Significant delays and low inventory detected due to supplier strike.\", \"causes\": \"Supplier strike; Low inventory; Delayed shipments\", \"affected_suppliers\": \"Supplier A; Supplier B\", \"recommendations\": \"Increase safety stock; Diversify suppliers; Negotiate alternative logistics\", \"risk_type\": \"Supply\", \"risk_reason\": \"Supplier strike has halted deliveries, causing supply shortages.\"}]\n\n"
